...
const ProductTag = ({ rating, review }) => {
  return (
    <>
      <div className={`${styles.card}`}>
        ...
        <div className={`${styles.statsWrapper}`}>
          <p className={`${styles.heading}`}>Review</p>
          <div className={`${styles.bottomWrapper}`}>
            <svg
              viewBox="0 0 512 512"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className={styles.count}>{review}k</p>
          </div>
        </div>
        <div className={`${styles.statsWrapper}`}>
          <p className={`${styles.heading}`}>Sells</p>
          <div className={`${styles.bottomWrapper}`}>
            <svg
              viewBox="0 0 512 512"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <p className={styles.count}>2.1k</p>
          </div>
        </div>
      </div>
    </>
